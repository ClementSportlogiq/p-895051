    ...
    >
      ...
      <CollapsibleContent className="mt-4 space-y-6">
        ...
        <div className="bg-white p-4 rounded border">
          <h3 className="font-medium mb-3">Current Default Configuration</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <h4 className="text-sm font-medium text-gray-700 mb-2">Quick Events ({configuredQuickEvents.length}/4)</h4>
            ...
            <div>
              <h4 className="text-sm font-medium text-gray-700 mb-2">Flag Definitions ({configuredFlagDefinitions.length})</h4>
              <div className="space-y-1">
